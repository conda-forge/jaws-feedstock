About jaws-feedstock
====================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/jaws-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3958&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jaws-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `jaws` can be installed with `conda`:
...
It is possible to list all of the versions of `jaws` available on your platform with `conda`:
...
```
mamba search jaws --channel conda-forge
```
...
mamba repoquery search jaws --channel conda-forge

# List packages depending on `jaws`:
mamba repoquery whoneeds jaws --channel conda-forge

# List dependencies of `jaws`:
mamba repoquery depends jaws --channel conda-forge
```
